...
//URLDecoder.decode("http://www.baidu.com", "UTF-8");
...
public class MainController {
    ...
    public void WebQRCode(HttpServletRequest request, HttpServletResponse response){
        String strClientUrl = request.getRequestURL().toString();
        int nPos = strClientUrl.indexOf('/', 7);
        if(nPos > 0) {
            strClientUrl = strClientUrl.substring(0, nPos);
        }
        String strContextPath = request.getContextPath();
        String strUrl = String.format("%s%s/index", strClientUrl, strContextPath);
    ...
    public void ZJAPP(String version, HttpServletRequest request, HttpServletResponse response){
        ...
        String strContextPath = request.getContextPath();
        String strUrl = String.format("%s%s/update/zjwork-v%s.apk", strClientUrl, strContextPath, version);
        CreateQRCodeImage(strUrl, request, response);
    }
    ...
    public void DDAPP(String version, HttpServletRequest request, HttpServletResponse response){
        ...
        String strContextPath = request.getContextPath();
        String strUrl = String.format("%s%s/update/ddwork-v%s.apk", strClientUrl, strContextPath, version);
        CreateQRCodeImage(strUrl, request, response);
    }
    ...
    public void POLEAPP(String version, HttpServletRequest request, HttpServletResponse response){
        ...
        String strContextPath = request.getContextPath();
        String strUrl = String.format("%s%s/update/work-v%s.apk", strClientUrl, strContextPath, version);
        CreateQRCodeImage(strUrl, request, response);
    }
